...
<html>
    <head>
        ...
        <title>Sumanas Technologies - Web Development</title>
    </head>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <span>Transforming ideas into spectacular websites </span> </div>
                </div>
            </div>
        </div>
            ...
            <div class="section header">
                <div class="section-inner">
                    <div class="master-head">
                        <p>" Just as we thought! Want to know more about what we do?<br/>
                            Its time to fasten your seatbelts!" </p>
                        <p class="scroll-button" onClick="$('.post-wrapper .post:first-child .stem-overlay .icon').click();"> <i class="fa fa-paper-plane" aria-hidden="true"></i> Ready to go for a ride?</p>
                    </div>
                </div>
                <!-- section-inner --> 
            </div>
                    ...
                    <div class="post-wrapper">
                        ...
                        <article class="post web-icon3" data-stem-color="blue">
                            ...
                            <div class="post-content post-content1 post-content3">
                                ...
                                <div class="post-logan1"> <img src="images/web-design-logo.png"  alt=""></div>
                            </div>
                        </article>
                        <article class="post web-icon4" data-stem-color="white">
                            ...
                            <div class="post-content post-content1 post-content4">
                                ...
                                <div class="post-logan1"> <img src="images/web-development-logos.jpg"  alt=""></div>
                            </div>
                        </article>
