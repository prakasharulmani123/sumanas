...
<html lang="en">
    <head>
        ...
        <title>Sumanas Technologies - Digital Marketing</title>
    </head>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="ui-ux-points1 digital-points1">
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4"> <img src="images/digital-marketing1.jpg"  alt=""></div>
                    ...
                    <div class="ui-ux-points1 digital-points1">
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-right"> <img src="images/digital-marketing2.png"  alt=""></div>
                        <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                    ...
                    <div class="ui-ux-points1 digital-points1">
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4"> <img src="images/digital-marketing3.png"  alt=""></div>
                        <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
