...
<html lang="en">
    <head>
        ...
        <title>Sumanas Technologies - Data Analytics</title>
    </head>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <div class="data-analytics-cont">
                            <div class="data-analytics-icon"> <img src="images/data-analytics1.png"  alt=""></div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <div class="data-analytics-cont">
                            <div class="data-analytics-icon"> <img src="images/data-analytics2.png"  alt=""></div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <div class="data-analytics-cont">
                            <div class="data-analytics-icon"> <img src="images/data-analytics3.png"  alt=""></div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <div class="data-analytics-cont">
                            <div class="data-analytics-icon"> <img src="images/data-analytics4.png"  alt=""></div>
                            <h4>4.Big Data </h4>
