            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <h1>Our Products </h1>
                        <span>Cras consectetur lorem at pulvinar ultricies. Cras id ante varius, congue arcu quis, posuere mauris. </span> </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="products-cont product1">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-7 products-txt">
                                ...
                                <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean a augue justo. In mollis erat in elit tempus, feugiat luctus ex sollicitudin. Maecenas euismod tortor dolor, vel blandit augue aliquam sit amet. Vestibulum et eros mollis, laoreet nisi ac, condimentum sapien. Aliquam nec nunc enim.</p>
                                <p> <a href="<?php echo "product-details.php"; ?>" class="btn readmore2"> Read More <i class="fa fa-chevron-right" aria-hidden="true"></i> </a> </p>
                            </div>
                        </div>
                    </div>
                    <div class="products-cont product1 product2">
                        <div class="row">
                            <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
                                <div class="productbg">
                            ...
                            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-7 products-txt products-txt2">
                                <h2> Sales<br/>
                                    Force </h2>
                                <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean a augue justo. In mollis erat in elit tempus, feugiat luctus ex sollicitudin. Maecenas euismod tortor dolor, vel blandit augue aliquam sit amet. Vestibulum et eros mollis, laoreet nisi ac, condimentum sapien. Aliquam nec nunc enim.</p>
                                <p> <a href="#" class="btn readmore2"> Read More <i class="fa fa-chevron-right" aria-hidden="true"></i> </a> </p>
                            </div>
                        </div>
                    </div>
