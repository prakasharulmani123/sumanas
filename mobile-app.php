...
<html lang="en">
    <head>
        ...
        <title>Sumanas Technologies - Mobile App Development</title>
    </head>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="ui-ux-points1 mobile-app-points">
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4"> <img src="images/mobile-app1.png"  alt=""></div>
                    ...
                    <div class="ui-ux-points1 mobile-app-points">
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-right"> <img src="images/mobile-app2.png"  alt=""></div>
                        <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                    ...
                    <div class="ui-ux-points1 mobile-app-points">
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4"> <img src="images/mobile-app3.png"  alt=""></div>
                        <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
