            ...
            <div class="section section1" id="section1">
                <div class="container-fluid">
                    ...
                    <div class="slogan1"> <span> WHAT </span> <br/>
                        MAKES US BETTER? </div>
                    <div class="arrow1"> <img src="images/arrow1.png" alt=""></div>
                            ...
                            <div class="col-xs-12 col-sm-4 col-lg-4 col-lg-4  sevice-part ">
                                <div class="row">
                                    ...
                                    <div class="sevice-part3">
                                        ...
                                        <p> <a href="<?php echo "digital-marketing.php"; ?>" class="readmore1"> Read More... </a> </p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-4 col-lg-4 col-lg-4  sevice-part ">
                                ...
                                <div class="row">
                                    <div class="sevice-part4">
                                        ...
                                        <p> <a href="<?php echo "webdevelopment.php"; ?>" class="readmore1"> Read More... </a> </p>
                                    </div>
