<?php
$title = "Our Website Services Overview";
include 'head.php';
?>
    <body class="innerpage">
        ...
        <div class="whatwedo">
                                ...
                                <div class="nano has-scrollbar" style="height:auto">
                                    <div class="nano-content pad-all" tabindex="0" style="right: -17px;">
                                        <ul class="list-unstyled media-block">
                                            <li class="mar-btm">
                                                <div class="media-left"> <img src="https://bootdey.com/img/Content/avatar/avatar1.png" class="img-circle img-sm" alt="Profile Picture"> </div>
                                            ...
                                            <li class="mar-btm">
                                                <div class="media-right"> <img src="https://bootdey.com/img/Content/avatar/avatar2.png" class="img-circle img-sm" alt="Profile Picture"> </div>
            ...
            <div class="conversation-txt-cont">
                <div class="paper-plane"> <img src="images/paper-plane.png"  alt=""></div>
                <div class="container-fluid">
                    <div class="conversation-txt">
                        ...
                        <p> <span> That's our moment of success! </span> </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                            <div class="servicebg1">
                                ...
                                <p class="readmore-icon"> <a href="<?php echo "ui-ux-design.php"; ?>"> <i class="fa fa-angle-right" aria-hidden="true"></i> </a> </p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                            <div class="servicebg1 servicebg3">
                                ...
                                <p class="readmore-icon"> <a href="<?php echo "digital-marketing.php"; ?>"> <i class="fa fa-angle-right" aria-hidden="true"></i> </a> </p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
